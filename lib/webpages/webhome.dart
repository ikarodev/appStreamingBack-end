...
import 'package:handsplay/model/sectionlistmodel.dart' as list;
import 'package:handsplay/model/sectionbannermodel.dart' as banner;
...
class WebHomeState extends State<WebHome> {
              ...
              child: Column(
                ...
                children: [
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      if ((sectionList?[index].videoType ?? 0) == 9)
                        Container(
                          alignment: Alignment.centerRight,
                          height: 17,
                          width: 17,
                  ...
                  if (/* (sectionList?[index].videoType ?? 0) == 9 && */
                      (sectionList?[index].shortTitle.toString() ?? "")
                          .isNotEmpty)
                    Container(
                      alignment: Alignment.centerLeft,
                      child: MyText(
  ...
  Widget setSectionData(
    ...
    /* video_type    =>  1- Video, 2- Show, 3- Category, 4-Language, 5- Upcoming Content, 6- Channel Content, 
                         7-  Kids Content, 8- Continue Watching, 9-Channel List, 10- Rent content */
    ...
    if ((sectionList?[index].screenLayout ?? "") == "landscape") {
      return landscape(sectionList?[index].videoType, sectionList?[index].data);
      ...
      return landscapeIndex(
          sectionList?[index].videoType, sectionList?[index].data);
    } else if ((sectionList?[index].screenLayout ?? "") == "portrait") {
      return portrait(sectionList?[index].videoType, sectionList?[index].data);
      ...
      return square(sectionList?[index].videoType, sectionList?[index].data);
  ...
  double getRemainingDataHeight(
    ...
    if (layoutType == "landscape" || layoutType == "index_landscape") {
      ...
      return ((sectionList?.length ?? 0) < 13)
  ...
  Widget landscape(int? videoType, List<Datum>? sectionDataList) {
    return SizedBox(
      width: MediaQuery.of(context).size.width,
  ...
  Widget landscapeIndex(int? videoType, List<Datum>? sectionDataList) {
    return SizedBox(
      width: MediaQuery.of(context).size.width,
      height: Dimens.isBigScreen(context)
          ? Dimens.heightLandWeb
                  ...
                  style: kIsWeb
                      ? TextStyle(
                          ...
                          foreground: Paint()
                            ...
                            ..strokeWidth = Dimens.isBigScreen(context) ? 8 : 6
  ...
  Widget landscapeBig(int? videoType, List<Datum>? sectionDataList) {
    return SizedBox(
      width: MediaQuery.of(context).size.width,
      height: Dimens.isBigScreen(context)
          ? Dimens.heightLandBigWeb
  ...
  Widget portrait(int? videoType, List<Datum>? sectionDataList) {
    return SizedBox(
      width: MediaQuery.of(context).size.width,
      height: Dimens.isBigScreen(context)
          ? Dimens.heightPortWeb
  ...
  Widget portraitBig(int? videoType, List<Datum>? sectionDataList) {
    return SizedBox(
      width: MediaQuery.of(context).size.width,
      height: Dimens.isBigScreen(context)
          ? Dimens.heightPortBigWeb
  ...
  Widget portraitIndex(int? videoType, List<Datum>? sectionDataList) {
    return SizedBox(
      width: MediaQuery.of(context).size.width,
      height: Dimens.isBigScreen(context)
          ? Dimens.heightPortWeb
                ...
                child: Text(
                  ...
                  style: kIsWeb
                      ? TextStyle(
                          ...
                          foreground: Paint()
                            ..style = PaintingStyle.stroke
                            ..strokeWidth = Dimens.isBigScreen(context) ? 8 : 5
                            ..color = colorPrimary.withValues(alpha: 0.4),
                        )
                      : GoogleFonts.inter(
                          textStyle: TextStyle(
  ...
  Widget square(int? videoType, List<Datum>? sectionDataList) {
    return SizedBox(
      width: MediaQuery.of(context).size.width,
      height: Dimens.isBigScreen(context)
          ? Dimens.heightSquareWeb
