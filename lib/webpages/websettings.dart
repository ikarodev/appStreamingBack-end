...
import 'package:handsplay/provider/myspaceprovider.dart';
                    ...
                    title: Constant.userID == null
                        ...
                        : ((userMobileNo ?? "").isEmpty
                            ? (((userFullname ?? "").isEmpty ||
                                ...
                                ? ("${userName ?? ""} ($myAccountText)")
                                : ("${userFullname ?? ""} ($myAccountText)"))
                            : ("${userMobileNo ?? ""} ($myAccountText)")),
          ...
          if ((subscriptionStatus != null && subscriptionStatus == "1") &&
            ...
            _buildSettingButton(
              ...
              onClick: () async {
                ...
                if (!mounted) return;
                if (Constant.userID != null) {
                  await subHistoryProvider.setLoading(true);
                  if (!mounted) return;
                  context.pushNamed(
