...
class ViewAllState extends State<ViewAll> {
  ...
  /* ========= Open Player ========= */
  openPlayer({required int position}) async {
    ...
    bool? isPrimiumUser = await Utils.checkSubsRentLogin(
      ...
      isBuy: viewAllProvider.continueWatchList?[position].isPremium ?? 0,
    ...
    PlayerModel playerModel = PlayerModel(
      playType:
          ((viewAllProvider.continueWatchList?[position].videoType ?? 0) == 2 ||
      ...
      episodeId: viewAllProvider.continueWatchList?[position].typeId ?? 0,
      videoUrl: viewAllProvider.continueWatchList?[position].video320 ?? "",
