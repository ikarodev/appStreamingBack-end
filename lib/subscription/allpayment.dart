...
import 'package:handsplay/provider/paymentprovider.dart';
import 'package:handsplay/provider/profileprovider.dart';
import 'package:handsplay/routes/routes_constant.dart';
import 'package:handsplay/subscription/instamojopg.dart';
...
import 'package:handsplay/subscription/stripe/stripe_checkout.dart';
...
class AllPaymentState extends State<AllPayment> {
  ...
  _flutterwaveInit() async {
    ...
    final Flutterwave flutterwave = Flutterwave(
      ...
      currency: Constant.currency,
      redirectUrl: 'https://www.yourappname.com',
      txRef: const Uuid().v1(),
  ...
  _paystackInit() async {
    ...
    PayWithPayStack().now(
      ...
      callbackUrl: 'https://www.yourappname.in/',
    );
  }
  /* ********* Paystack END ********* */
